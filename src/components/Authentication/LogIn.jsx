...
const LogIn = () => {
    ...
    const {signInEmailPassword , google} = useContext(AuthContext)
  const {
    register,
    handleSubmit,
    ...
    return (
      ...
      <div className="hero-content flex-col lg:flex-row-reverse">
        <div className="text-center lg:text-left">
          ...
          <button onClick={google} className="btn btn-full lg:btn-wide btn-outline">Google</button>
          <button className="btn btn-full lg:btn-wide btn-outline">Github</button>
          </div>
