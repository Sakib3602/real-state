  ...
  return (
    <div className="min-h-[500px] w-[100%] m-auto rounded-lg ">
      <div className="pt-[110px] lg:pt-[138px] lg:pl-[90px] lg:mt-0 flex flex-col lg:flex-row ">
        <img
          className="h-full w-full lg:h-[360px] lg:w-[400px]"
          src={`${
            person.photoURL ||
        ...
        <div className="ml-12 space-y-9">
          <h1 className="text-[30px] md:text-[40px] lg:text-[46px] font-[700]">
            Name : {person.displayName || "Not Set"}
          </h1>
          <h1 className="text-[26px] md:text-[40px] lg:text-[46px] font-[700]">Email : {person.email}</h1>
