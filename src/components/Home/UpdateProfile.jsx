  ...
  return (
    <div className="min-h-[500px] w-[100%] m-auto rounded-lg p-3 border">
      <div className="pt-[110px] lg:pt-[138px] lg:pl-[90px] lg:mt-0 flex flex-col lg:flex-row ">
        ...
        <p className="mb-4">Unlock the full potential of your digital presence by updating your profile. A current profile reflects your evolving journey, highlights your achievements, and opens doors to new opportunities. Make your first impression count, every time. Update now and keep your story fresh and engaging for all who discover you.</p>
        </div>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 m-auto border p-8 rounded-lg">
